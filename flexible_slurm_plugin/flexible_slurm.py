...
executor_plugin_name = "FlexibleSlurmExecutor"


class FlexibleSlurmExecutor(BaseAsyncExecutor):
    """Flexible slurm executor plugin class.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.slurm_flexible = slurm_flexible
